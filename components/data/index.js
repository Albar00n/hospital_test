...
export const linksCall = [
  { id: 1, name: "Emergency", text: "(237) 681-812-255", icon: "/icons/phone.svg" },
  { id: 2, name: "Work Hour", text: "09:00 - 20:00 Everyday", icon: "/icons/clock.svg" },
  { id: 3, name: "Location", text: "0123 Some Place", icon: "/icons/location.svg" },
];

export const services = [
  { id: 1, name: "A Passion for Healing" },
  { id: 2, name: "5-Star Care" },
  { id: 3, name: "All our best" },
  { id: 4, name: "Believe in Us" },
  { id: 5, name: "Always Caring" },
  { id: 6, name: "A Legacy of Excellence" },
];
export const cards = [
